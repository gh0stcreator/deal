...
export const buildTelegramBot = (
  ...
  const askProblemDefinition = async (
    ...
    const text = [
      'Важно:',
      '',
      'Ты можешь писать как есть, не подбирая формулировки.',
      'Другой человек не увидит это сообщение напрямую.',
      '',
      'Сначала я соберу ситуацию отдельно с каждой стороны.',
      'Потом покажу, где вы совпадаете, а где нет.',
      'И предложу варианты, как можно договориться.',
      '',
      'Давай начнём.',
      '',
